...
_G.packer_plugins = {
  ...
  ["bufdelete.nvim"] = {
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/bufdelete.nvim",
  ...
  ["null-ls.nvim"] = {
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/null-ls.nvim",
  ...
  ["vim-visual-multi"] = {
    loaded = true,
    path = "/home/dani/.local/share/nvim/site/pack/packer/start/vim-visual-multi",
